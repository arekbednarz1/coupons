...
public final class Coupon {
	...
	public CouponUsedResult useOnce(String userId, String ipAddress) {
		...
		return new CouponUsedResult(updated, event);
	}
	...
	public record CouponUsedResult(Coupon updatedCoupon, CouponUsedEvent event) {
	}
}
